...
class AuthUser(Base):
    ...
    email_verification_code_hash = Column(String)
    ...
    email_verification_last_sent_at = Column(DateTime(timezone=True))
    email_verified_at = Column(DateTime(timezone=True))
    password_reset_code_hash = Column(String)
    password_reset_expires_at = Column(DateTime(timezone=True))
    password_reset_attempts = Column(Integer, nullable=False, default=0)
    password_reset_last_sent_at = Column(DateTime(timezone=True))
